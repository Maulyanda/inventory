        ...
        ?>
            <tr>
                ...
                <td class="text-center" width="12%">
                    ...
                    <a href="<?php echo base_url() ?>Staff/hapus_receivingkd/<?php echo $r1->kd_receivingkd ?> " onclick="return confirm('Anda Yakin Ingin Menghapusnya ?')" class="btn btn-default btn-xs xtooltip" title="Hapus"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
        <?php
            }
