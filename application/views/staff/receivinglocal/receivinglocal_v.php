...
<div class="row">
    <div id="receivinglocal_fm" class="col-md-4"><?php $this->load->view('Staff/receivinglocal/receivinglocal_fm_v') ?></div>
    <div id="receivinglocal_dt" class="col-md-8"><?php $this->load->view('Staff/receivinglocal/receivinglocal_dt_v') ?></div>
</div>
