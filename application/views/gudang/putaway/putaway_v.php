...
<div class="row">
    <div id="putaway_fm" class="col-md-4"><?php $this->load->view('gudang/putaway/putaway_fm_v') ?></div>
    <div id="putaway_dt" class="col-md-8"><?php $this->load->view('gudang/putaway/putaway_dt_v') ?></div>
</div>
