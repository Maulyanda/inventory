...
<div class="row">
    <div id="outbound_fm" class="col-md-4"><?php $this->load->view('gudang/outbound/outbound_fm_v') ?></div>
    <div id="outbound_dt" class="col-md-8"><?php $this->load->view('gudang/outbound/outbound_dt_v') ?></div>
</div>
