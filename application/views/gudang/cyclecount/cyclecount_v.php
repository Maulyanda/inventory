...
<div class="row">
    <div id="cyclecount_fm" class="col-md-4"><?php $this->load->view('gudang/cyclecount/cyclecount_fm_v') ?></div>
    <div id="cyclecount_dt" class="col-md-8"><?php $this->load->view('gudang/cyclecount/cyclecount_dt_v') ?></div>
</div>
