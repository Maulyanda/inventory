...
<div class="row">
    <div id="receivingkd_fm" class="col-md-4"><?php $this->load->view('gudang/receivingkd/receivingkd_fm_v') ?></div>
    <div id="receivingkd_dt" class="col-md-8"><?php $this->load->view('gudang/receivingkd/receivingkd_dt_v') ?></div>
</div>
