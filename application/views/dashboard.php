...
<div class="row">
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
      ...
      <span class="info-box-icon"><i class="fa fa-thumbs-o-up"></i></span>
      <div class="info-box-content">
        <a href="Gudang/outbound" class="btn bg-yellow">OUTBOUND</a>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
      ...
      <span class="info-box-icon"><i class="fa fa-thumbs-o-up"></i></span>
      <div class="info-box-content">
        <a href="Gudang/putaway" class="btn bg-red">PUTAWAY</a>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
      ...
      <span class="info-box-icon"><i class="fa fa-thumbs-o-up"></i></span>
      <div class="info-box-content">
        <a href="Gudang/receivingkd" class="btn bg-blue">RECEIVING KD</a>
...
<div class="row">
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
      ...
      <span class="info-box-icon"><i class="fa fa-thumbs-o-up"></i></span>
      <div class="info-box-content">
        <a href="Staff/receivinglocal" class="btn bg-purple">RECEIVING LOCAL</a>
        <span class="info-box-number"><?php echo $receivinglocal ?></span>
        <!-- The progress section is optional -->
        <div class="progress">
          <div class="progress-bar" style="width: 100%"></div>
